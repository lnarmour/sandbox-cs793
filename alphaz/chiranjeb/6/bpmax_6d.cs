...
#setSpaceTimeMap(prog, system, "NR_FTable",      "(i1,j1,i2,j2    ->  j1-i1,  i1, j1,   j2-i2, i2,   j2)");
#PrintAST(prog);
setSpaceTimeMap(prog, system, "NR_FTable",   "(i1,j1,i2,j2,k1,k2 ->  j1-i1,  i1, k1,   i2,    k2,    j2-i2)", 
                                             "(i1,j1,i2,j2       ->  j1-i1,  i1, i1-1, i2,    i2-1,  j2-i2)");

#SetMemorySpace(prog, system, "NR_FTable", "NR_FTable_Alpha_init");

#PrintAST(prog);
#setSpaceTimeMap(prog, system, "NR_FTable_4", "(i1,j1,i2,j2,k1    ->  j1-i1,  i1, k1,   i2,    j2-i2, 0)", 
#                                             "(i1,j1,i2,j2       ->  j1-i1,  i1, i1-1, i2,    j2-i2, 0)");

setSpaceTimeMap(prog, system, "NR_FTable_1", "(i1,j1,i2,j2       ->  j1-i1,  i1, j1,   j2-i2, i2,   j2)");
setSpaceTimeMap(prog, system, "NR_FTable_2", "(i1,j1,i2,j2       ->  j1-i1,  i1, j1,   j2-i2, i2,   j2)");
setSpaceTimeMap(prog, system, "NR_FTable_3", "(i1,j1,i2,j2       ->  j1-i1,  i1, j1,   j2-i2, i2,   j2)");
setSpaceTimeMap(prog, system, "NR_FTable_4", "(i1,j1,i2,j2       ->  j1-i1,  i1, j1,   j2-i2, i2,   j2)");
