...
#outDir = "./../../src/progs/bpmax/schedule_6d/diag_left_2_right_coarse_double/autogen";
...
outDir = "out";
setSpaceTimeMap(prog, system, "S1",           "(i,j               ->  0,     0,    0,   0,     0,       0,   j-i,   i)");
setSpaceTimeMap(prog, system, "S2",           "(i,j               ->  0,     0,    0,   0,     0,       0,   j-i,   i)");
setSpaceTimeMap(prog, system, "FTable",       "(i1,j1,i2,j2       ->  1,  M-i1,   j1,   j1,    N-i2,    1,   j2,    j2)");
setSpaceTimeMap(prog, system, "NR_FTable",    "(i1,j1,i2,j2,k1,k2 ->  1,  M-i1,   j1,   k1,    N-i2,    0,   k2,    j2)", 
                                              "(i1,j1,i2,j2       ->  1,  M-i1,   j1,   i1-1,  N-i2,    0,   i2-1,  j2)");
setSpaceTimeMap(prog, system, "NR_FTable_1",  "(i1,j1,i2,j2,k1    ->  1,  M-i1,   j1,   k1,    -1,      0,   i2,    j2)", 
                                              "(i1,j1,i2,j2       ->  1,  M-i1,   j1,   i1-1,  -1,      0,   i2,    j2)");
setSpaceTimeMap(prog, system, "NR_FTable_2",  "(i1,j1,i2,j2,k1    ->  1,  M-i1,   j1,   k1,    -1,      0,   i2,    j2)", 
                                              "(i1,j1,i2,j2       ->  1,  M-i1,   j1,   i1-1,  -1,      0,   i2,    j2)");                                             
setSpaceTimeMap(prog, system, "NR_FTable_3",  "(i1,j1,i2,j2,k2    ->  1,  M-i1,   j1,   j1,    N-i2,    1,   k2,    j2)", 
                                              "(i1,j1,i2,j2       ->  1,  M-i1,   j1,   j1,    N-i2,    1,   i2-1,  j2)");                                                                           
setSpaceTimeMap(prog, system, "NR_FTable_4",  "(i1,j1,i2,j2,k2    ->  1,  M-i1,   j1,   j1,    N-i2,    1,   k2,    j2)", 
                                              "(i1,j1,i2,j2       ->  1,  M-i1,   j1,   j1,    N-i2,    1,   i2-1,  j2)");
setParallel(prog, system, "", "7");
AShow(prog, system);
generateScheduledCode(prog, system, outDir);
