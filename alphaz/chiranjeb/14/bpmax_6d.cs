...
#setSpaceTimeMap(prog, system, "S1",          "(i,j               ->  -100,    0,   0,     0,        j-i,   i)");
#setSpaceTimeMap(prog, system, "S2",          "(i,j               ->  -100,    0,   0,     0,        j-i,   i)");
#setSpaceTimeMap(prog, system, "FTable",      "(i1,j1,i2,j2       ->  j1-i1,   i1,  j1,    j2-i2,    i2,    j2)");
#setSpaceTimeMap(prog, system, "NR_FTable",   "(i1,j1,i2,j2,k1,k2 ->  j1-i1,   i1,  k1,    i2,       k2,    j2)", 
#                                             "(i1,j1,i2,j2       ->  j1-i1,   i1,  i1-1,  i2,       i2-1,  j2)");
#setSpaceTimeMap(prog, system, "NR_FTable_1", "(i1,j1,i2,j2,k1    ->  j1-i1,   i1,  k1,    N+1,      i2,    j2)", 
#                                             "(i1,j1,i2,j2       ->  j1-i1,   i1,  i1-1,  N+1,      i2,    j2)");
#setSpaceTimeMap(prog, system, "NR_FTable_2", "(i1,j1,i2,j2,k1    ->  j1-i1,   i1,  k1,    N+1,      i2,    j2)", 
#                                             "(i1,j1,i2,j2       ->  j1-i1,   i1,  i1-1,  N+1,      i2,    j2)");                                             
#setSpaceTimeMap(prog, system, "NR_FTable_3", "(i1,j1,i2,j2,k2    ->  j1-i1,   i1,  j1,    j2-i2,    i2,    k2)", 
#                                             "(i1,j1,i2,j2       ->  j1-i1,   i1,  j1,    j2-i2,    i2,    i2-1)");                                                                           
#setSpaceTimeMap(prog, system, "NR_FTable_4", "(i1,j1,i2,j2,k2    ->  j1-i1,   i1,  j1,    j2-i2,    i2,    k2)", 
#                                             "(i1,j1,i2,j2       ->  j1-i1,   i1,  j1,    j2-i2,    i2,    i2-1)");
...
outDir = "./out";
setSpaceTimeMap(prog, system, "S1",          "(i,j               ->  -100,    0,   0,     0,       M-i,   j)");
setSpaceTimeMap(prog, system, "S2",          "(i,j               ->  -100,    0,   0,     0,       N-i,   j)");
setSpaceTimeMap(prog, system, "FTable",      "(i1,j1,i2,j2       ->  M-i1,   j1,   j1,    j2-i2,    i2,    j2)");
setSpaceTimeMap(prog, system, "NR_FTable",   "(i1,j1,i2,j2,k1,k2 ->  M-i1,   j1,   k1,    N-i2,     k2,    j2)", 
                                             "(i1,j1,i2,j2       ->  M-i1,   j1,   i1-1,  N-i2,     i2-1,  j2)");
setSpaceTimeMap(prog, system, "NR_FTable_1", "(i1,j1,i2,j2,k1    ->  M-i1,   j1,   k1,    -1,       i2,    j2)", 
                                             "(i1,j1,i2,j2       ->  M-i1,   j1,   i1-1,  -1,       i2,    j2)");
setSpaceTimeMap(prog, system, "NR_FTable_2", "(i1,j1,i2,j2,k1    ->  M-i1,   j1,   k1,    -1,       i2,    j2)", 
                                             "(i1,j1,i2,j2       ->  M-i1,   j1,   i1-1,  -1,       i2,    j2)");                                             
setSpaceTimeMap(prog, system, "NR_FTable_3", "(i1,j1,i2,j2,k2    ->  M-i1,   j1,   j1,    j2-i2,    i2,    k2)", 
                                             "(i1,j1,i2,j2       ->  M-i1,   j1,   j1,    j2-i2,    i2,    i2-1)");                                                                           
setSpaceTimeMap(prog, system, "NR_FTable_4", "(i1,j1,i2,j2,k2    ->  M-i1,   j1,   j1,    j2-i2,    i2,    k2)", 
                                             "(i1,j1,i2,j2       ->  M-i1,   j1,   j1,    j2-i2,    i2,    i2-1)");
